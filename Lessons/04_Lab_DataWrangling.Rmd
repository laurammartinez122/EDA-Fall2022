...
TuesdayLake <- filter(NTL.phys.data, lakename == "Tuesday Lake")
NTL.phys.data.1990thru1999 <- filter(TuesdayLake, year4 >= 1990, year4 <= 1999)

#another way to do it
NTL.phys.data.Ex2 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 >= 1990 & year4 <= 1999)

#using arrange function
NTL.phys.data.Ex2.2 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 %in% c(1990:1999))
```
...
# month(sampledate) == 7
# daynum %in% c(183:213) did not work, why?
